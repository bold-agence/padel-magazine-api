...
export class InitSchema1778073871738 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "articles_tags" ("article_id" uuid NOT NULL, "tag_id" uuid NOT NULL, CONSTRAINT "PK_eeda07761f3734f20e6ce8f83dd" PRIMARY KEY ("article_id", "tag_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_0844b8f28aa32ef4bb5885d500" ON "articles_tags" ("article_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_82ccd5e9ccf84c6c2445a5331f" ON "articles_tags" ("tag_id") `);
        await queryRunner.query(`ALTER TABLE "sections" ADD CONSTRAINT "FK_8f4d6dd51a254be39fc5786c80a" FOREIGN KEY ("articleId") REFERENCES "articles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "articles" ADD CONSTRAINT "FK_9cf383b5c60045a773ddced7f23" FOREIGN KEY ("categoryId") REFERENCES "article_categories"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "articles_tags" ADD CONSTRAINT "FK_0844b8f28aa32ef4bb5885d5003" FOREIGN KEY ("article_id") REFERENCES "articles"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "articles_tags" DROP CONSTRAINT "FK_82ccd5e9ccf84c6c2445a5331fa"`);
        await queryRunner.query(`ALTER TABLE "articles_tags" DROP CONSTRAINT "FK_0844b8f28aa32ef4bb5885d5003"`);
        await queryRunner.query(`ALTER TABLE "articles" DROP CONSTRAINT "FK_9cf383b5c60045a773ddced7f23"`);
        await queryRunner.query(`ALTER TABLE "sections" DROP CONSTRAINT "FK_8f4d6dd51a254be39fc5786c80a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_82ccd5e9ccf84c6c2445a5331f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0844b8f28aa32ef4bb5885d500"`);
        ...
        await queryRunner.query(`DROP TABLE "client_breaking_news"`);
        await queryRunner.query(`DROP TABLE "client_ad_images"`);
        await queryRunner.query(`DROP TABLE "breaking_news"`);
        await queryRunner.query(`DROP TABLE "players"`);
        await queryRunner.query(`DROP TABLE "homepage_ads"`);
